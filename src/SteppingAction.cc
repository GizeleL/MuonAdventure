...
void SteppingAction::UserSteppingAction(const G4Step *theStep) {
    ...
    G4VUserTrackInformation *trackInformation =
        static_cast<G4VUserTrackInformation *>(theTrack->GetUserInformation());
    ...
    if (thePostPoint->GetStepStatus() == fGeomBoundary) {
        ...
        //         //       G4Exception("SteppingAction:", "Expl01", JustWarning, ed, "");
        //         return;
        //     }
    }
    fExpectedNextStatus = Undefined;
